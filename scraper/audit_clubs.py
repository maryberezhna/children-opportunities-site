...
# Лише з початку слова: «цін» сидить усередині «повноцінного», і 21.09.2026
# «Фантазію» ЦПР так переставило на платне цитатою про папір та олівці.
# Власні матеріали — не плата організатору.
COST_WORDS = re.compile(r"(?<!\w)(грн|₴|uah|оплат|платн|вартіст|цін[аиу]|абонемент|внес[оку]|"
                        r"безкоштовн|безоплатн)", re.I)
