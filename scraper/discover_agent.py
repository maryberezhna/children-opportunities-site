...
RARE_FOCUS = (
    ...
    "України. НЕ бери місцеву послугу чужої країни — муніципальний фонд, клуб "
    "при бібліотеці, гурток вихідного дня в чужому містечку — навіть якщо вона "
    "формально відкрита для всіх. "
    "НЕ бери чужі виплати, субсидії й компенсації: дитяча допомога іншої "
    "держави чи громади — для тамтешніх мешканців. Конкурси, обміни та "
    "стипендії за кордоном — беремо. "
    "НЕ бери те, що вимагає проживати в цій країні: місцева школа, "
...
def _prompt(kw: str, region: dict) -> str:
    ...
    return (
        ...
        "  участь неможлива, навіть часткової. Безкоштовний лише пробний чи\n"
        "  перший урок — paid_affordable. Інших значень немає.\n"
