...
NEED_PATTERNS = {
    ...
    # Саме «ветеран» ловило програми ДЛЯ ветеранів (доросла авдиторія):
    # так на сторінку для дітей захисників потрапила Академія Жіночого
    # Лідерства для активісток і ветеранок. Потрібна звʼязка з дитиною чи
    # родиною, а не сама згадка ветеранів (аудит 11.09.2026).
    "veteran_family": [
        "дітей ветеран", "діти ветеран", "дитин ветеран", "родин ветеран",
        "дітей захисник", "діти захисник", "дітей військовослужбовц",
        "дітей військових", "діти військових", "родин військових",
        "загиблих захисник", "загиблих військов", "загиблих героїв",
        "дітей героїв", "діти героїв", "родин загиблих", "дітей полеглих",
    ],
