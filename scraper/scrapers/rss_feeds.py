...
FEEDS: list[tuple[str, str]] = [
    ...
    # Додано 14.09.2026: після вимкнення гурткових скраперів (01.09) звичайний
    # пошук давав 0–15 записів на день, і жодного системного джерела конкурсів
    # для школярів. Обидва центри — державні організатори всеукраїнських
    # конкурсів і фестивалів для учнів, а не агрегатори.
    # НЕНЦ — основна стрічка (стрічка категорії «конкурси» мертва з 2015-го);
    # живе щодня: запрошення учнів, «Птах року», «Юний дослідник» тощо.
    ("Національний еколого-натуралістичний центр", "https://nenc.gov.ua/?feed=rss2"),
    # УДЦПО пише рідко (остання новина 29.05.2026), зате лише всеукраїнські
    # творчі конкурси й фестивалі для дітей.
    ("Український державний центр позашкільної освіти", "https://udcpo.gov.ua/feed/"),
    # Додано 20.09.2026 зі списку джерел Марії. Обидві стрічки перевірені
    # живцем того ж дня: JA Ukraine — свіжий запис 16.09.2026, EdEra —
    # 02.09.2026. Решту кандидатів з її шортліста не беремо, і ось чому:
    # «Велика ідея» віддає 520 через Cloudflare, Studway не має RSS узагалі
    # (/feed/ → 301, /rss → HTML), GoGlobal і platforma.volunteer.country —
    # 404. Мертву стрічку в списку тримати гірше, ніж не мати її зовсім:
    # вона щодня з'їдає перевірку й нічого не дає.
    ("Junior Achievement Ukraine", "https://ja-ukraine.org/feed/"),
    ("EdEra", "https://ed-era.com/feed/"),
]
