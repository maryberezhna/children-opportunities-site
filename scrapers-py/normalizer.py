...
6. Визначити cities — масив локацій де доступна можливість
...
ПРАВИЛА для cities:
- Якщо онлайн/дистанційно → додай "Онлайн"
- Якщо вказано конкретне українське місто → додай його (Київ, Харків, Львів, Одеса, Дніпро тощо)
- Якщо "по всій Україні" або "всі регіони" → додай "Вся Україна"
- Якщо за кордоном (Польща, Німеччина, Лондон тощо) → додай "Міжнародні"
- Може бути кілька: наприклад ["Онлайн", "Київ"] або ["Онлайн", "Міжнародні"]
- Якщо нічого не вказано → порожній масив []
