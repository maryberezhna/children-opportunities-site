...
// І лише тоді, коли постійність прочитана в джерелі, а не проставлена за
// замовчуванням (timing_assumed): саме здогад «набір постійний» тримав на
// сайті 610 гуртків, про які ніхто нічого не перевіряв.
const evergreen = (v) => v.kind === 'permanent' && !v.has_dates && !v.assumed;
