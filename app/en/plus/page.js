...
const DESCRIPTION = `Dityam+ subscription: every day we match opportunities to each child by age, interests and city, and remind you about deadlines. UAH 99/month.${PLUS_SALES_OPEN ? '' : ' Coming soon.'}`;
