...
// 2. Про ціну кави нічого не стверджуємо: 119 грн/міс — це менше за 30 грн на
//    тиждень, і фраза «менше за одну каву на тиждень» лишається правдою,
//    скільки б та кава не коштувала.
//
...
const T = {
  uk: {
    ...
    script: 'для дитини',
    text: (price) => `Dityam+ коштує ${price} грн на місяць — менше за одну каву на тиждень. `
  ...
  en: {
    ...
    text: (price) => `Dityam+ costs UAH ${price} a month — less than one coffee a week. `
