...
export const metadata = {
  ...
  description: 'Dityam.com.ua — платформа перевірених можливостей для українських дітей 0–18 років, в Україні та за кордоном. Безкоштовно для родини, без реєстрації й реклами. Засновниця — Марія Шутяк.',
  alternates: {
      ...
      <main className="v2-container ab-page">
        <section className="v2-hero pk-hero">
          <div className="v2-hero-copy">
            ...
            <p className="v2-hero-sub">
              ...
              перевірені й оновлені щодня. Безкоштовно для родини, без реєстрації,
              без реклами.
            </p>
        ...
        <section className="v2-bottom">
          ...
          <div className="v2-panel">
            <h2>Підтримати</h2>
            <p>
              Платформа безкоштовна для родин і без реклами — назавжди. Розвиватися
