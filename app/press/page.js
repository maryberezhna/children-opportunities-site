...
export const metadata = {
  ...
  description:
    'Прескіт dityam.com.ua: цифри проєкту, опис одним абзацом, логотипи, контакт для журналістів. Каталог можливостей для дітей 0-18 років в Україні.',
  ...
  return (
    <div className="container">
      ...
      <article className="legal-page">
        ...
        <h2>Коротко</h2>
        <ul>
          <li><strong>Що це:</strong> каталог можливостей для дітей в Україні</li>
