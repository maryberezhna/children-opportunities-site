        ...
        <div className="support-content">
          ...
          <div className="support-text">
            ...
            <p className="support-description">
              Привіт, я Маша. Вірю, що кожна дитина в Україні має знати про свої можливості — від безкоштовного гуртка у своєму місті до стипендії за кордон. Саме тому створила цей сайт: щоб зібрати все в одному місці. Якщо маєте змогу підтримати — це допоможе проекту розвиватися і додавати більше можливостей для дітей🧡
            </p>
          </div>
