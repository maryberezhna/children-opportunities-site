      ...
      {isOpen ? (
        <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) setIsOpen(false); }}>
          <div className="modal">
            ...
            <p>
              Я роблю цю платформу сама, щоб кожна українська родина знайшла можливості для своєї дитини. Ваша підтримка допомагає додавати нові програми й покращувати сайт. Реклами тут немає, а доступ до можливостей безкоштовний.
            </p>
