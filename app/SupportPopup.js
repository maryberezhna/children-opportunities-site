        ...
        <div className="support-content">
          ...
          <div className="support-text">
            ...
            <p className="support-description">
              Привіт, я Маша. Вірю, що кожна дитина в Україні має знати про свої можливості — від безкоштовного гуртка у своєму місті до стипендії за кордон. Якщо маєте змогу підтримати — це допоможе проекту розвиватися і додавати більше можливостей для дітей🧡 Будь-якою сумою.
            </p>
          </div>
