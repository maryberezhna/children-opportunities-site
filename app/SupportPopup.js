        ...
        <div className="support-content">
          ...
          <div className="support-text">
            ...
            <p className="support-description">
              Привіт! Я Мері — створила цей сайт, щоб зібрати всі можливості для дітей в одному місці. Роблю це на ентузіазмі, без реклами. Якщо сайт корисний — підтримайте, щоб я могла додавати більше програм 🧡
            </p>
          </div>
