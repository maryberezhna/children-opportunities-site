...
- [Dityam+](${SITE}/plus) ([English](${SITE}/en/plus)): платна підписка в Telegram. Батьки заповнюють короткий профіль для кожної дитини: вік, вподобання, формат участі, місто й, за бажанням, особливі обставини. Щодня підписка перебирає нові можливості й надсилає ті, що підходять; про дедлайн нагадує завчасно — за 4 і 2 тижні для стипендій, грантів і обмінів, за 2 тижні для конкурсів і таборів, за тиждень для гуртків. Ціна: ${PRICE} грн на місяць або ${PRICE_YEAR} грн на рік, скасування командою /stop. ${PLUS_SALES_OPEN ? 'Оформлення — у Telegram-боті @DityamPlusBot; можливості й нагадування приходять у Telegram.' : 'Продаж ще не відкрито; записатися в список очікування можна в Telegram-боті @DityamPlusBot.'} Сама платформа й усі можливості на ній лишаються безкоштовними для всіх.
