...
async function sendPayOffer(bot, sub, chatId, supabase) {
  ...
  const text = '🧡 <b>Dityam+</b>\n\n'
    + 'У безкоштовному каталозі — те, що доступно завжди: держдопомога, виплати, '
    + 'постійні курси.\n'
    + 'У Dityam+ — те, що треба встигнути: конкурси, стипендії, обміни, табори. '
    + 'Відбираємо вручну і надсилаємо, поки подача відкрита.\n'
    + proof
    + '\n<b>Що входить:</b>\n'
    + '• Можливості з дедлайном, яких немає в загальному каталозі\n'
