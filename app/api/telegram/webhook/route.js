...
${username || chatId} · з телеграм-посту`);
  ...
  await sendMessage(msg.chat.id, existing
    ...
    : 'Ви в списку перших! 🧡\n\nDityam+ — платна підписка: 179 грн/міс або 1 490 грн/рік. Ми памʼятаємо, куди ваша дитина вже подавалась і що їй підійшло, — і пропонуємо не випадкові картки, а наступний крок. Плюс нагадування про дедлайни завчасно: за 2–4 тижні для стипендій, грантів і обмінів, за тиждень — для курсів і гуртків.\n\nЩойно запустимось — напишемо вам сюди першим, зі знижкою для перших. А платформа Dityam.com.ua лишається безкоштовною для всіх.');
