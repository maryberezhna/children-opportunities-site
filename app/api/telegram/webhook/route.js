...
${username || chatId} · з телеграм-посту`);
  ...
  await sendMessage(msg.chat.id, existing
    ...
    : 'Ви в списку перших! 🧡\n\nDityam+ — це платна помісячна підписка: відбір можливостей під вашу дитину, нагадування про дедлайни, допомога з подачею. Щойно запустимось — напишемо вам сюди першим, зі знижкою для перших.\n\nА каталог dityam.com.ua був і лишається безкоштовним.');
