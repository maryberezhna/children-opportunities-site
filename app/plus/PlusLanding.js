...
const L = {
  uk: {
    ...
    contrastBItems: [
      ...
      // Розіграші й знижки партнерів: механізму ще немає, дату старту не
      // визначено, тож «пізніше», а не конкретний місяць (Марія, 17.09.2026;
      // до того стояло «з жовтня»).
      'Відмічайте «Цікаво» чи «Не цікаво», а пізніше — беріть участь у розіграшах подарунків і отримуйте знижки від партнерів',
    ],

    mockTitle: 'Що приходить у Telegram',
    mockSub: 'Назва, вік, вартість, дедлайн і посилання на деталі — достатньо, щоб за хвилину вирішити, чи подаватись. Під кожною можливістю — «Цікаво» й «Не цікаво», а якщо в неї є дата — ще й «Додати в календар».',
    flow: {
      play: 'Відтворити',
      pause: 'Пауза',
      steps: [
  ...
  en: {
    ...
    contrastBItems: [
      ...
      'Mark “Interested” or “Not interested”, and later join partner giveaways and get partner discounts',
    ],
