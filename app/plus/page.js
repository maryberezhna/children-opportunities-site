...
export const metadata = {
  ...
  description: 'Dityam+ памʼятає, куди ваша дитина вже подавалась, і пропонує наступний крок, а не випадкові картки. Нагадування про дедлайни завчасно — за 2–4 тижні для стипендій і обмінів, за тиждень для гуртків. 179 грн/міс або 1 490 грн/рік. Станьте в список — першим знижка.',
