...
const DESCRIPTION = `Підписка Dityam+: щодня добираємо можливості для кожної дитини за віком, вподобаннями й містом і нагадуємо про дедлайни. 99 грн/міс.${PLUS_SALES_OPEN ? '' : ' Скоро.'}`;
