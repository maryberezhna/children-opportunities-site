...
const L = {
  uk: {
    ...
    soon: 'скоро',
    waitNote: 'Ми саме дороблюємо Dityam+ — платну підписку (99 грн/міс або 999 грн/рік). Станьте в список у Telegram — дізнаєтесь про запуск першими, і перший місяць буде безкоштовним.',
    ...
    openNote: 'Dityam+ — платна підписка: 99 грн/міс або 999 грн/рік. Оформлюється в Telegram-боті за кілька хвилин: питання про дитину, потім оплата.',
  ...
  en: {
    ...
    soon: 'soon',
    waitNote: 'We’re still building Dityam+, a paid subscription (UAH 99/month or UAH 999/year). Join the list on Telegram to hear about the launch first and get your first month free.',
    waitCta: 'Join the list on Telegram',
    submit: 'Tell me first',
    fine: 'The platform stays free for everyone · no spam · ',
    support: 'support the project',
    openNote: 'Dityam+ is a paid subscription: UAH 99/month or UAH 999/year. You set it up in the Telegram bot in a few minutes: questions about your child, then payment.',
