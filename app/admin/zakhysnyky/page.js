  ...
  if (url && key) {
    ...
    const [d, a] = await Promise.all([
      supabase.from('opportunities')
        .select('id, title, source, source_url, opportunity_type, age_from, age_to, cost_type, deadline, event_end_date, recurrence, format, cities, countries, is_international, admin_comment, created_at')
