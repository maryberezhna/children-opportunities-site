...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Каталог безкоштовних та доступних програм для дітей 0-18 років в Україні. 265+ перевірених можливостей з 40+ джерел.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
        height: 630,
        alt: 'dityam.com.ua — усі можливості для дітей в одному місці',
      },
    ],
  },
  twitter: {
