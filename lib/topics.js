 ...
 *   showPromo false — прибрати промо Dityam+ після четвертої картки;
...
export const TOPICS = {
  ...
  'za-kordon': {
    ...
    heading: { lead: 'Дитина їде', script: 'за кордон', tail: '\u00a0— обміни, стипендії, табори' },
    ...
    en: {
      ...
      heading: { lead: 'Going', script: 'abroad', tail: '\u00a0— exchanges, scholarships, camps' },
  ...
  'dity-zakhysnykiv': {
    ...
    // більше»). Пояснення, як влаштований список, — у note нижче.
    intro:
    ...
    en: {
      ...
      note:
        'At the top of the list, marked “Only for children of defenders”, is what requires the family’s defender status. Below are programmes for several groups of children where the organiser names children of defenders among the priorities: free camps and recovery stays, career guidance. Everything else on the platform is open too — the “Special needs” filter has a separate option for children of defenders. Almost every programme asks for a document confirming the status. Prepare the scans in advance: for programmes with a short intake it decides whether you make it. Admission benefits at colleges and universities are arranged by the institution itself — ask its admissions office.',
      faq: [
        {
