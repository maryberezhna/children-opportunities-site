...
export const TOPICS = {
   ...
   *
   * Два блоки (рішення Марії 14.09.2026). Відкритих програм САМЕ для дітей
   * захисників мало: дослідження 14.09.2026 перебрало ~70 кандидатів і
   * знайшло кілька. Тому сторінка ділиться чесно:
  ...
  'dity-zakhysnykiv': {
    ...
    intro:
      'Тут два блоки. Перший — те, де статус родини є умовою участі: виплати, стипендії, навчання й підтримка саме для дітей захисників і захисниць. Другий — програми для кількох категорій дітей, де дітей захисників організатор називає серед пріоритетних: безкоштовні табори й оздоровлення, профорієнтація. Окрім цієї сторінки, дитині доступне все інше на платформі — фільтр «Особлива потреба» має окремий пункт для дітей захисників.',
    blocks: {
      exclusive: 'Лише для дітей захисників і захисниць',
      exclusiveLede: 'Статус родини захисника чи захисниці — умова участі.',
      rest: 'Діти захисників — серед пріоритетних',
      restLede: 'Програми для кількох категорій дітей, де організатор окремо називає дітей захисників і захисниць.',
    },
    note:
      'Майже скрізь статус підтверджують документом: посвідчення члена родини захисника, посвідчення дитини учасника бойових дій або довідка з військової частини. Складіть скан-копії заздалегідь — у програм із коротким набором це вирішує, встигнете ви чи ні. Пільги при вступі до коледжу чи університету (компенсація контрактного навчання, гуртожиток, підручники) оформлює сам заклад освіти — по них звертайтесь у приймальну комісію.',
    faq: [
      {
    ...
    en: {
      ...
      photo: { src: '/topic-zakhysnyky', alt: 'Girls in embroidered shirts with Ukrainian flags at a celebration' },
      ...
      intro:
        'Two sections. The first lists what requires the family’s defender status: payments, scholarships, schooling and support only for children of defenders. The second lists programmes for several groups of children where the organiser names children of defenders among the priority groups: free camps and recovery stays, career guidance. Everything else on the platform is open to these children too — the “Special needs” filter has a separate option for children of defenders.',
      blocks: {
        exclusive: 'Only for children of defenders',
        exclusiveLede: 'The family’s defender status is a condition of entry.',
        rest: 'Children of defenders among the priority groups',
        restLede: 'Programmes for several groups of children, where the organiser names children of defenders separately.',
      },
      note:
    ...
    photo: { src: '/topic-zakhysnyky', alt: 'Дівчата у вишиванках із українськими прапорцями на святі' },
    match: (o) => {
