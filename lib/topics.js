 ...
 *   heroImage { src, alt } — фото праворуч у хіро (src без розширення,
 *             поруч лежать .webp і .jpg); без нього хіро в одну колонку;
...
export const TOPICS = {
  ...
  'dity-zakhysnykiv': {
    ...
    intro:
      'Виплати, стипендії, табори й підтримка для дітей захисників і захисниць України — одним списком. Нагорі, з позначкою «Лише для дітей захисників», — те, де статус родини є умовою участі. Далі — програми для кількох пільгових категорій, де дітей захисників організатор називає серед пріоритетних: безкоштовні табори й оздоровлення, профорієнтація. Окрім цієї сторінки, дитині доступне все інше на платформі — фільтр «Особлива потреба» має окремий пункт для дітей захисників.',
