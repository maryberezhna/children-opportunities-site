...
export const CATEGORY_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      // Веде на тематичну сторінку, а не в каталог: там текст, FAQ про
      // підтвердження статусу й пільги при вступі — саме те, що шукають.
      { label: 'Дітям захисників і захисниць', labelEn: 'Children of defenders', href: '/dity-zakhysnykiv' },
      // Та сама пігулка «Виплати», що на головній (OpportunitiesList,
      // type=payments): allowance, support_payment або aid_type = cash.
      // Спершу посилання фільтрувало по opportunity_type = 'gov_aid', якого в
      // базі немає, потім вело на ?aid=cash — а цього параметра головна не
      // читає взагалі: «Державні виплати 26» відкривали весь список (15.09.2026).
      // «Державні» прибрано: серед виплат є міські й обласні.
      { label: 'Виплати на дітей', labelEn: 'Payments for children', href: url({ type: 'payments' }), match: (o) => t(o, 'allowance', 'support_payment') || o.aid_type === 'cash' },
    ],
  },
  {
