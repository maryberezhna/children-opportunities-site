...
// Кінцівка. «Дякуємо» Марія відхилила 23.09.2026: «можна якось краще».
// Тому три різні — кожна каже, ЩО САМЕ змінить ця відповідь. Людина щойно
// витратила на нас десять секунд; ввічливість тут дешева, користь — ні.
export const THANKS_USED = 'Записали 🧡 Тепер знаємо, що вам підходить, — підбиратимемо точніше.';
export const THANKS_NOT_USED = 'Записали. Менше зайвого в наступних добірках.';
export const THANKS_SKIP = 'Гаразд. Головне, що відповіли — цього вже досить.';

/** Кінцівка під те, що людина відповіла. */
export const thanksFor = (stage) => (stage === 'used' ? THANKS_USED : THANKS_NOT_USED);
