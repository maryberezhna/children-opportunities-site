...
const AMOUNT_YEAR = Number(process.env.WAYFORPAY_AMOUNT_YEAR || 1199);
// Знижка для списку очікування (рішення Марії 14.09.2026): перший місяць 89 грн.
const AMOUNT_EARLY = Number(process.env.WAYFORPAY_AMOUNT_EARLY || 89);
...
// людину щомісяця списували б по 89 грн назавжди. На річну знижка не діє.
