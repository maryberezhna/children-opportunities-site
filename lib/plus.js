...
// і отримати обіцяне — промокод FIRST (перший місяць 1 грн замість 99, перший
// рік 499 замість 999). Сам промокод від цього прапорця не залежить: бот
// пропонує оплату й зараз, тож код працює, щойно людина його введе.
