...
const COPY = {
  uk: {
    ...
    stats: [['179 грн', 'на місяць'], ['1 199 грн', 'на рік'], ['за 4 тижні', 'нагадування про стипендії']],
  },
  en: {
    chip: 'subscription · soon',
    ...
    stats: [['UAH 179', 'a month'], ['UAH 1,199', 'a year'], ['4 weeks ahead', 'scholarship reminders']],
  },
};
