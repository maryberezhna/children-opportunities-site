...
export async function beginFlow(bot, supabase, chatId, handle) {
  ...
  await bot.sendMessage(chatId, '🧡 <b>Налаштуймо добірку</b>\n\nТри короткі питання — і ми надсилатимемо можливості саме для вашої дитини. Персональних даних дитини не запитуємо — лише вік, інтереси й чи показувати платні можливості.');
